...
```
conda create --name sw python=3.12
conda activate sw
...
```
cd ..
git clone https://github.com/mugitaku/ScienceWorld.git
cd ScienceWorld
...
```
python python -m agent_code.clin_agent --task-num "4" --var-num 1 --env-step-limit 2 --num-episodes 1  --gpt-model "gpt-4-0613" --summarize_end_of_episode 1  --device "cpu"  --temperature 0.0  --use-gold-memory-in-ep0 0 --gold-traces "" --use-last-k-memories 3 --quadrant 1 --simplifications-preset "easy" --output-path-prefix logs/testrun/
```
